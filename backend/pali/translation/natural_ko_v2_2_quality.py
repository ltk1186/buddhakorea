...
def glossary_lock_entries_v2_2() -> list[GlossaryEntry]:
    return [
        ...
        GlossaryEntry("sati", ["마음챙김"], ["기억", "수념"], [], "Use project convention; in anussati/saraṇa contexts, inspect context rather than forcing 마음챙김 mechanically."),
        GlossaryEntry("viññāṇa", ["알음알이"], ["의식"], [], "Prefer 알음알이 in literal_ko and terms; avoid Yogācāra-style expansion."),
        GlossaryEntry("paññā", ["통찰지"], ["지혜"], [], "Prefer 통찰지 in literal_ko and terms; do not expand into later 반야/공사상 meanings."),
        GlossaryEntry("āyatana / saḷāyatana", ["감각장소", "여섯 감각장소"], [], [], "Use the established sense-base convention."),
        GlossaryEntry("phassa", ["감각접촉"], [], [], "Stable dependent-origination term."),
        GlossaryEntry("nibbidā", ["염오"], [], [], "Stable project rendering."),
        GlossaryEntry("virāga", ["탐욕의 빛바램"], [], [], "Stable project rendering."),
        GlossaryEntry("saṅkhāra", ["형성된 것들", "심리현상들", "의도적 행위들"], [], [], "Choose by context: aggregates, dependent origination, or conditioned phenomena generally."),
        GlossaryEntry("nibbāna", ["열반"], [], ["불성", "진여", "본래면목"], "Do not layer later doctrinal meanings onto nibbāna."),
        GlossaryEntry("khandha", ["무더기"], ["오온"], ["무리"], "Default is 무더기; natural_ko may support first occurrence with 오온 where helpful."),
        GlossaryEntry("manasikāra", ["마음에 잡도리함"], ["여리작의", "비여리작의"], [], "yoniso/ayoniso manasikāra use the project terms 여리작의/비여리작의."),
        GlossaryEntry("uppala / paduma", ["수련", "연꽃"], [], [], "Do not collapse uppala and paduma into the same Korean term when the distinction matters."),
        GlossaryEntry("dhīra / paṇḍita", ["슬기로운 이", "현자"], [], [], "Do not collapse the two terms into one repeated rendering when the distinction matters."),
        GlossaryEntry("khanti", ["감내", "참음", "인욕"], ["수순", "받아들임"], [], "In anulomika khanti or truth-acceptance contexts, consider 수순/받아들임 and mark uncertainty if unclear."),
