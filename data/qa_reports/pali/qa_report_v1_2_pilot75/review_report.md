...
- parse failed: 0
- Priority counts: {'B': 1, 'C': 1}
- auto-resolvable groups: 1
- human-needed groups: 1
- estimated human review minutes: 3
...
- run manifest: `data/qa_reports/pali/qa_report_v1_2_pilot75/run_manifest.json`
...
- current pass/fail/escalate: 4 / 1 / 0
