...
- run manifest: `data/qa_reports/pali/qa_report_300_live_salvaged_integrated_batch_mode/run_manifest.json`
...
| Recommended sampling size | 10 |

- classifier mode: `auto`
- classifier enabled: `true`
- findings: `data/qa_reports/pali/qa_report_300_live_salvaged_integrated_batch_mode/findings.json`
